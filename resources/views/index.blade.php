    ...
    <x-slot:heading>
        <section>
            <div class="flex lg:flex-row-reverse xl:flex-row xl:relative">
                <div class="xl:absolute right-0 z-0 xl:pt-4 md:max-h-96 xl:h-auto">
                ...
                <div class="z-10">
                    <div class="xl:ml-4 lg:w-full">
                        ...
                        <h1 class="xl:text-9xl lg:text-5xl font-anton xl:max-w-4xl lg:pt-4 xl:pt-6">
                            The Evolution of
                            Web Design
                        </h1>
                        <div class="py-2">
                        ...
                        <div class="font-sans sm:text-xs xl:text-md py-4 max-w-xl">
                            <p class="py-2 pr-2 mx-2 xl:w-widthCustom1 h-auto indent-10 text-justify">

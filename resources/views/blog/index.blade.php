<x-layout>
    ...
    <section>
        <div class="h-[2070px] pd-14">
            ...
            <div class="w-auto h-auto space-y-16">
                                        ...
                                        <div class="flex items-center justify-between py-4 mx-4">
                                            ...
                                            <div class="flex flex-row items-center gap-2">
                                                ...
                                                <div class="flex flex-row gap-1">
                                                    <div
                                                        class="px-3 py-3 text-gray-800 transition-all duration-200 bg-transparent border-2 border-gray-500 rounded-full focus:bg-gray-600 hover:text-white focus:text-white hover:bg-gray-600 hover:border-gray-600 focus:border-gray-600">
            ...
            <div class="pt-6 mt-2"> {{ $articles->links() }} </div>
        </div>
        <x-divider />
    </section>

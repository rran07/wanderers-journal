                                        ...
                                        <div class="flex items-center justify-between py-4 mx-4">
                                            ...
                                            <div class="flex flex-row items-center gap-2">
                                                ...
                                                <div class="flex flex-row gap-1">
                                                    <div
                                                        class="px-3 py-3 text-gray-800 transition-all duration-200 bg-transparent border-2 border-gray-300 rounded-full focus:bg-gray-600 hover:text-white focus:text-white hover:bg-gray-600 hover:border-gray-600 focus:border-gray-600">
